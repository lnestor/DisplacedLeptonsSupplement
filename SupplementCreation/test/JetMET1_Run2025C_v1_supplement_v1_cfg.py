...
config.General.requestName = 'JetMET1_Run2025C_v1_supplement_v1'
...
config.Data.inputDataset = '/JetMET1/Run2025C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'JetMET1_Run2025C_v1_supplement_v1'
