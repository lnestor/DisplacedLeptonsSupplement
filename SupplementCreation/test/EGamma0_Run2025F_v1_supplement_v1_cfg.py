...
config.General.requestName = 'EGamma0_Run2025F_v1_supplement_v1'
...
config.Data.inputDataset = '/EGamma0/Run2025F-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'EGamma0_Run2025F_v1_supplement_v1'
