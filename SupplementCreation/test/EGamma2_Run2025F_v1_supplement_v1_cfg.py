...
config.General.requestName = 'EGamma2_Run2025F_v1_supplement_v1'
...
config.Data.inputDataset = '/EGamma2/Run2025F-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'EGamma2_Run2025F_v1_supplement_v1'
