...
config.General.requestName = 'Muon1_Run2025F_v1_supplement_v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'supplement_mumu_cfg.py'
...
config.Data.outputDatasetTag = 'Muon1_Run2025F_v1_supplement_v1'
