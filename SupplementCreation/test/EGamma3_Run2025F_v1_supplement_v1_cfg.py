...
config.General.requestName = 'EGamma3_Run2025F_v1_supplement_v1'
...
config.Data.inputDataset = '/EGamma3/Run2025F-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'EGamma3_Run2025F_v1_supplement_v1'
