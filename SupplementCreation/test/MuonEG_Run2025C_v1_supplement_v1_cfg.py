...
config.General.requestName = 'MuonEG_Run2025C_v1_supplement_v1'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'supplement_emu_cfg.py'
config.JobType.outputFiles = ['supplement.root']
config.JobType.maxMemoryMB = 3000
config.JobType.numCores = 1

config.Data.inputDataset = '/MuonEG/Run2025C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'MuonEG_Run2025C_v1_supplement_v1'
