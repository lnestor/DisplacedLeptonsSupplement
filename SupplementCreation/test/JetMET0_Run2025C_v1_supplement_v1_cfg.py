...
config.General.requestName = 'JetMET0_Run2025C_v1_supplement_v1'
...
config.Data.inputDataset = '/JetMET0/Run2025C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'JetMET0_Run2025C_v1_supplement_v1'
