...
config.General.requestName = 'EGamma1_Run2025F_v1_supplement_v1'
...
config.Data.inputDataset = '/EGamma1/Run2025F-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'EGamma1_Run2025F_v1_supplement_v1'
