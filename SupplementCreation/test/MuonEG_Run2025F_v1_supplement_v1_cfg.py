...
config.General.requestName = 'MuonEG_Run2025F_v1_supplement_v1'
...
config.Data.inputDataset = '/MuonEG/Run2025F-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'MuonEG_Run2025F_v1_supplement_v1'
